...
const Navbar = () => {
  ...
  return (
    <Disclosure
      ref={navAnimation}
      as="nav"
      className="sticky top-0 z-30 bg-gradient-to-tr from-indigo-500 via-pink-500 to-blue-500 "
    >
                  ...
                  <a
                    ...
                    className={classNames(
                      item.current
                        ...
                        : " border  text-white  ",
                      "rounded-full px-3 py-2 text-xs hover:bg-blue-600/30 hover:scale-[108%] duration-300 ease-out "
                    )}
                  >
                    {item.name}
                  </a>
